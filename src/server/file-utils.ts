...
export async function getDirectoryTree(dirPath: string, rootDir: string): Promise<FileNode[]> {
...
export function isTextFile(filename: string, mimeType: string): boolean {
  ...
  if (textFilenames.includes(filename.toLowerCase())) return true;
